...
import com.ennovations.fitcrucoach.quickbox.services.MIN_OPPONENT_SIZE
import com.ennovations.fitcrucoach.quickbox.utils.*
import com.quickblox.core.QBEntityCallbackImpl
import com.quickblox.sample.videochat.kotlin.fragments.ConversationFragmentCallback
...
class CallActivity : BaseActivity(), IncomeCallFragmentCallbackListener,
    ...
    // private val tApponitmentFragment= TApponitmentFragment
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(com.ennovations.fitcrucoach.R.layout.activity_main_quickblox)
        ...
        connectionView = View.inflate(
            this,
            com.ennovations.fitcrucoach.R.layout.connection_popup,
            null
        ) as LinearLayout
    }
    ...
    private fun startScreenSharing(data: Intent?) {
        ...
        if (fragmentByTag !is ScreenShareFragment) {
            addFragment(
                supportFragmentManager, com.ennovations.fitcrucoach.R.id.fragment_container,
    ...
    private fun checkPermission() {
        ...
        if (isVideoCall && checkPermissions(PERMISSIONS)) {
            if (cam) {
                ...
                com.ennovations.fitcrucoach.quickbox.utils.showErrorSnackbar(
                    rootView,
                    getString(com.ennovations.fitcrucoach.R.string.error_permission_video),
                    com.ennovations.fitcrucoach.R.string.dlg_allow,
            ...
            if (mic) {
                ...
                com.ennovations.fitcrucoach.quickbox.utils.showErrorSnackbar(
                    rootView,
                    com.ennovations.fitcrucoach.R.string.error_permission_audio,
                    "Allow Permission",
                    com.ennovations.fitcrucoach.R.string.dlg_allow,
                    object : View.OnClickListener {
                        override fun onClick(v: View?) {
    ...
    override fun finish() {
        ...
        // TAppointmentFragment.start(this@CallActivity)
        ...
        if (callService.currentSessionExist()) {
            ...
            if (supportFragmentManager.findFragmentByTag(INCOME_CALL_FRAGMENT) == null) {
                addFragment(
                    ...
                    com.ennovations.fitcrucoach.R.id.fragment_container,
                    fragment,
    ...
    private fun showConnectionPopUp() {
        runOnUiThread {
            val fragmentContainer: FrameLayout =
                findViewById(com.ennovations.fitcrucoach.R.id.fragment_container)
            val connectionNotificationView: TextView? =
                connectionView?.findViewById(com.ennovations.fitcrucoach.R.id.notification)
            connectionNotificationView?.setText(com.ennovations.fitcrucoach.R.string.connection_was_lost)
    ...
    override fun onReceiveHangUpFromUser(
        ...
        if (callService.isCurrentSession(session)) {
            ...
            /*  val participantName =
              ...
              shortToast("User " + participantName + " " + getString(com.ennovations.fitcrucoach.R.string.text_status_hang_up) + " conversation")*/
        }
        Log.v("recivehangup", "hello")
    }
