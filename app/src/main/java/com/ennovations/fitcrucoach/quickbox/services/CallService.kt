package com.ennovations.fitcrucoach.quickbox.services
...
import com.ennovations.fitcrucoach.fragments.CAMERA_ENABLED
import com.ennovations.fitcrucoach.fragments.IS_CURRENT_CAMERA_FRONT
import com.ennovations.fitcrucoach.fragments.MIC_ENABLED
import com.ennovations.fitcrucoach.fragments.SPEAKER_ENABLED
import com.ennovations.fitcrucoach.quickbox.db.QbUsersDbManager
import com.ennovations.fitcrucoach.quickbox.util.NetworkConnectionChecker
...
class CallService : Service() {
    ...
    override fun onCreate() {
        ...
        initListeners()
        initAudioManager()
        ringtonePlayer = RingtonePlayer(this, com.ennovations.fitcrucoach.R.raw.beep)
        super.onCreate()
    }
...
/*
    private fun initNotification(): Notification {
        ...
        val notificationTitle = getString(com.ennovations.fitcrucoach.R.string.text_push_notification_message,
            Hawk.get(NAME)
        )      */
/*  var notificationText =
            getString(com.ennovations.fitcrucoach.R.string.notification_text, "")*//*
...
/*  if (!TextUtils.isEmpty(callTime)) {
            notificationText =
                getString(com.ennovations.fitcrucoach.R.string.notification_text, callTime)
        }
*//*
      ...
      //  bigTextStyle.bigText(notificationText)
        ...
        val channelId: String = if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.O) {
            ...
            getString(com.ennovations.fitcrucoach.R.string.app_name)
        }
       ...
       // builder.setContentText(notificationText)
        ...
        builder.setSmallIcon(com.ennovations.fitcrucoach.R.drawable.placeholder)
       */
/* val bitmapIcon = BitmapFactory.decodeResource(
            resources,
            com.ennovations.fitcrucoach.R.mipmap.ic_launcher
        )*//*
...
*/
    ...
    private fun createNotificationChannel(channelId: String, channelName: String): String {
        ...
        channel.lightColor = getColor(com.ennovations.fitcrucoach.R.color.green)
    ...
    private inner class QBRTCSignalingListener : QBRTCSignalingCallback {
        ...
        override fun onErrorSendingPacket(
            ...
            shortToast(com.ennovations.fitcrucoach.R.string.dlg_signal_error)
        }
    }
