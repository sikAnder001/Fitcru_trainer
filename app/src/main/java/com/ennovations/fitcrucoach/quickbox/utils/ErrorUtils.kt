...
private val NO_CONNECTION_ERROR = SessionManager.getInstance().getString(R.string.error_connection)
private val NO_RESPONSE_TIMEOUT =
    SessionManager.getInstance().getString(R.string.error_response_timeout)

private val NO_INTERNET_CONNECTION =
    SessionManager.getInstance().getString(R.string.no_internet_connection)
...
fun showErrorSnackbar(
    ...
    val errorMessageString = SessionManager.getInstance().getString(errorMessage)
