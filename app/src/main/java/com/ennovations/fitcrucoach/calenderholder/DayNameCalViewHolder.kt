...
class DayNameCalViewHolder internal constructor(
    itemView: View,
    onItemListener: DayNameCalAdapter.OnItemListener,
    days: List<LocalDate>
    ...
    private val onItemListener: DayNameCalAdapter.OnItemListener
